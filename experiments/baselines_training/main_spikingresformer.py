...
from baselines.submodules.layers import Conv1x1, Conv3x3, Linear, SpikingMatmul
import baselines.spikingresformer # do not remove this registers the models
from utils.spikingvit.augment import DVSAugment
from utils.spikingvit.scheduler import BaseSchedulerPerEpoch, BaseSchedulerPerIter
from utils.spikingvit.utils import RecordDict, GlobalTimer, Timer
from utils.spikingvit.utils import count_convNd, count_linear, count_matmul
from utils.spikingvit.utils import DatasetSplitter, DatasetWarpper, CriterionWarpper, DVStransform, SOPMonitor
from utils.spikingvit.utils import is_main_process, save_on_master, tb_record, accuracy, safe_makedirs
...
def parse_args():
    ...
    config_parser.add_argument(
        ...
        "--config",
        type=str,
        default="../configs/spikingresformer_cifar10.yaml",
        metavar="FILE",
    ...
    # argument of TET
    parser.add_argument('--TET', action='store_true', help='Use TET baselines_training')
    ...
    parser.add_argument('--amp', type=bool, default=True, help='Use AMP baselines_training')
    parser.add_argument('--sync-bn', action='store_true', help='Use SyncBN baselines_training')
